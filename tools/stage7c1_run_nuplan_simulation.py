...
PLANNER_PROFILES = {
    ...
    "pdm_closed_conservative_v2": pdm_closed_profile("conservative_v2", "full_closed_loop_planner", {
        "idm_policies.speed_limit_fraction": [0.2, 0.4, 0.6, 0.8],
        "idm_policies.fallback_target_velocity": 10.0,
        "idm_policies.min_gap_to_lead_agent": 2.0,
        "idm_policies.headway_time": 2.0,
        ...
        "idm_policies.decel_max": 3.0,
        "lateral_offsets": [-0.5, 0.5],
        "scorer.progress_weight": 3.0,
        "scorer.ttc_weight": 8.0,
        "scorer.comfortable_weight": 4.0,
        "tracker.q_lateral": [1.0, 8.0, 1.0],
        "tracker.r_lateral": [2.0],
        "tracker.curvature_rate_penalty": 0.03,
        "motion_model.steering_angle_time_constant": 0.08,
        "comfort.max_abs_lat_accel": 3.5,
        "comfort.max_abs_yaw_rate": 0.7,
        "comfort.max_abs_yaw_accel": 1.5,
    }),
    "pdm_closed_assertive_v2": pdm_closed_profile("assertive_v2", "full_closed_loop_planner", {
        "idm_policies.speed_limit_fraction": [0.4, 0.6, 0.8, 1.0],
        "idm_policies.fallback_target_velocity": 18.0,
        "idm_policies.min_gap_to_lead_agent": 0.5,
        "idm_policies.headway_time": 1.0,
        ...
        "scorer.ttc_weight": 3.0,
        "scorer.comfortable_weight": 1.0,
        "tracker.q_lateral": [2.0, 15.0, 0.0],
        "tracker.r_lateral": [0.5],
        "tracker.curvature_rate_penalty": 0.005,
        "motion_model.steering_angle_time_constant": 0.03,
        "comfort.max_abs_lat_accel": 5.5,
        "comfort.max_abs_yaw_rate": 1.1,
        "comfort.max_abs_yaw_accel": 2.3,
    }),
